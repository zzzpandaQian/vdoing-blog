...
<script>
import Home from '@theme/components/Home.02.vue'
import Navbar from '@theme/components/Navbar.02.vue'
import Page from '@theme/components/Page.02.vue'
import CategoriesPage from '@theme/components/CategoriesPage.02.vue'
import TagsPage from '@theme/components/TagsPage.02.vue'
import ArchivesPage from '@theme/components/ArchivesPage.02.vue'
import Sidebar from '@theme/components/Sidebar.02.vue'
import Buttons from '@theme/components/Buttons.02.vue'

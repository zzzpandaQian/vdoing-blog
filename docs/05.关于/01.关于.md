...
## 📚Blog
这是一个兼具博客文章、知识管理、文档查找的个人网站，主要内容是Web前端技术。如果你喜欢这个博客&主题欢迎到[GitHub](https://github.com/zzzpandaQian)点个Star，或者交换[友链](/friends/) ( •̀ ω •́ )✧
...
[<img src="https://github-readme-stats.vercel.app/api/pin/?username=xugaoyi&amp;repo=vuepress-theme-vdoing" alt="ReadMe Card" class="no-zoom">](https://github.com/zzzpandaQian)
...
本站主题是 [`Vdoing`](https://github.com/zzzpandaQian)，这是一款简洁高效的VuePress 知识管理&博客 主题。旨在轻松打造一个`结构化`与`碎片化`并存的个人在线知识库&博客，让你的知识海洋像一本本书一样清晰易读。配合多维索引，让每一个知识点都可以快速定位！ [Github地址](https://github.com/zzzpandaQian) | [在线vscode预览源码](https://github1s.com/xugaoyi/vuepress-theme-vdoing)
...
<script>
  export default {
    ...
    mounted(){
      ...
      if(flag){
        this.qqUrl = 'mqqwpa://im/chat?chat_type=wpa&uin=307097167&version=1&src_type=web&web_src=oicqzone.com'
      }
    }
  }
</script>
